...
export const methodOptions: { value: METHOD; label: string }[] = [
  ...
  { value: METHOD.MIDDLE_POINT, label: "Метод средней точки" },
  ...
  { value: METHOD.KUTTA_MERSON, label: "Метод Кутты-Мерсона" },
  {
    value: METHOD.EXPLICIT_2STEP_ADAMS,
    label: "Явный двухшаговый метод Адамса",
  },
